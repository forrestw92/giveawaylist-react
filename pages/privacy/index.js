  ...
  return (
    <React.Fragment>
      ...
      <div className={"content"}>
        <p>
          This Privacy Policy governs the manner in which Giveaway List
          collects, uses, maintains and discloses information collected from
          users (each, a "User") of the http://Giveawaylist.com website
          ("Site").
        </p>
        ...
        <p>
          ...
          our Site. Users may be asked for, as appropriate, email address. Users
        ...
        <p>
          Giveaway List may collect and use Users personal information for the
          following purposes:
        </p>
        <ul>
          <li>
        ...
        <p>
          Giveaway List has the discretion to update this privacy policy at any
        ...
        <p>
          ...
          >
            with the https://PrivacyPolicies.com generator
          </a>
          .
        </p>
        <h3>Contacting us</h3>
        ...
        <p>This document was last updated on September 10, 2017</p>
      </div>
